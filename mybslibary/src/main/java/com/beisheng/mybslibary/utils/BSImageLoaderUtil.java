 ...
 */
public class BSImageLoaderUtil {
    ...
    public static String getSavePath(int type) {
        ...
        if (checkSDCard()) {
            path = Environment.getExternalStorageDirectory().toString() + File.separator + "BSKJ" + File.separator
                    + folder + File.separator;

        } else {
            path = Environment.getDataDirectory().toString() + File.separator + "BSKJ" + File.separator + folder
                    + File.separator;
        }
        return path;
    }
