...
public class LoadingView extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.BS_LoadingView);
        String loadText = typedArray.getString(R.styleable.BS_LoadingView_loadingText);
        int textAppearance = typedArray.getResourceId(R.styleable.BS_LoadingView_loadingText, -1);
        mDelay = typedArray.getInteger(R.styleable.BS_LoadingView_delay, 80);
        typedArray.recycle();
