package com.beisheng.mybslibary.imgsel.cameralibrary;
...
import com.beisheng.mybslibary.imgsel.cameralibrary.listener.CaptureListener;
import com.beisheng.mybslibary.imgsel.cameralibrary.listener.ClickListener;
import com.beisheng.mybslibary.imgsel.cameralibrary.listener.ErrorListener;
import com.beisheng.mybslibary.imgsel.cameralibrary.listener.JCameraListener;
import com.beisheng.mybslibary.imgsel.cameralibrary.listener.ReturnListener;
import com.beisheng.mybslibary.imgsel.cameralibrary.listener.TypeListener;
import com.beisheng.mybslibary.imgsel.cameralibrary.state.CameraMachine;
import com.beisheng.mybslibary.imgsel.cameralibrary.util.FileUtil;
import com.beisheng.mybslibary.imgsel.cameralibrary.util.LogUtil;
import com.beisheng.mybslibary.imgsel.cameralibrary.util.ScreenUtils;
import com.beisheng.mybslibary.imgsel.cameralibrary.view.CameraView;
...
//    private static final int TYPE_FLASH_AUTO = 0x021;
    ...
    public JCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mContext = context;
        //get AttributeSet
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.JCameraView_BS, defStyleAttr, 0);
        iconSize = a.getDimensionPixelSize(R.styleable.JCameraView_BS_iconSize, (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_SP, 35, getResources().getDisplayMetrics()));
        iconMargin = a.getDimensionPixelSize(R.styleable.JCameraView_BS_iconMargin, (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_SP, 15, getResources().getDisplayMetrics()));
        iconSrc = a.getResourceId(R.styleable.JCameraView_BS_iconSrc, R.mipmap.ic_camera);
        iconLeft = a.getResourceId(R.styleable.JCameraView_BS_iconLeft, 0);
        iconRight = a.getResourceId(R.styleable.JCameraView_BS_iconRight, 0);
        duration = a.getInteger(R.styleable.JCameraView_BS_duration_max, 10 * 1000);       //没设置默认为10s
        a.recycle();
        initData();
        initView();
    }
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    public void setImageViewGone() {
        ...
        mCaptureLayout.txt_tip.setVisibility(GONE);
    }
...
//                break;
            case TYPE_FLASH_ON:
                mFlashLamp.setImageResource(R.mipmap.ic_flash_on);
                machine.flash(Camera.Parameters.FLASH_MODE_ON);
                break;
            case TYPE_FLASH_OFF:
                mFlashLamp.setImageResource(R.mipmap.ic_flash_off);
